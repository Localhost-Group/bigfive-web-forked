...
el inventario es de <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
  ...
  compare: {
    comparision_results: "Resultados de la comparación"
  },
  toolbar: {
    home: "Inicio",
    result: "Resultados",
  ...
  test: {
    ...
    accept2:
      "Doy mi consentimiento para que mis datos sean procesados con fines de marketing por CampusAI Holding LLC, 16192 Coastal Hwy, 19958 Lewes (opcional)",
